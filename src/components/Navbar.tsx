          ...
          <div className="md:hidden flex items-center gap-3">
            {!isLoggedIn && (
              <>
                <Link
                  href="/login"
                  className="px-3 py-1.5 text-sm font-medium text-white/90 hover:text-white rounded-md transition-colors"
                >
                  登录
                </Link>
                <Link
            ...
            <button
              ...
              className="p-2 text-white rounded-md hover:bg-white/10 transition-colors focus:outline-none"
              aria-label="菜单"
            >
              <svg
                className="w-6 h-6"
            ...
            {isLoggedIn && (
              <>
                <div className="border-t border-white/10 pt-3 mt-2 space-y-1">
                  ...
                  <button
                    onClick={handleLogout}
                    className="w-full text-left px-3 py-2.5 text-sm text-red-300 hover:bg-red-900/20 rounded-lg transition-colors"
                  >
                    退出登录
                  </button>
                </div>
