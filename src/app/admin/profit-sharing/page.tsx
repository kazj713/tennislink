  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">管理平台分账规则、接收方和结算流程</p>
      </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div className={`${section.bgColor} p-4 rounded-lg`}>
                  <Icon size={24} className={section.color.replace("bg-", "text-")} />
                </div>
                <div>
      ...
      <div className="mt-8 bg-blue-50 rounded-xl p-6 border border-blue-100">
        <h2 className="text-lg font-semibold text-blue-800 mb-4">操作指南</h2>
