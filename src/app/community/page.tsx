...
export default function CommunityPage() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setPosts([
        {
          id: 1,
          user: { name: '网球爱好者', avatarColor: 'from-primary-light to-primary' },
        ...
        {
          id: 3,
          user: { name: '球技提升中', avatarColor: 'from-primary-light to-primary' },
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#F5F5EF]/50 to-gray-50 pt-16 pb-16 flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
          ...
          <button
            ...
            className="px-6 py-3 bg-primary hover:bg-primary-dark text-white font-semibold transition-colors w-full sm:w-auto"
          >
            发布动态
          </button>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {challenges.map((challenge) => (
                ...
                >
                  ...
                  {challenge.status === 'ongoing' && (
                    <div className="mb-4">
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span className="font-semibold text-primary">{challenge.progress}/{challenge.days}</span>
                      </div>
                  ...
                  <button className="w-full py-2 bg-primary hover:bg-primary-dark text-white font-semibold transition-colors">
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <textarea
                ...
                className="w-full h-40 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-light outline-none resize-none mb-4"
              />
              ...
              <button className="w-full py-3 bg-primary hover:bg-primary-dark text-white font-semibold transition-colors">
                发布
              </button>
            </div>
          </div>
