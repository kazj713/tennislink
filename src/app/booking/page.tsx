        ...
        <div className="flex items-center justify-center mb-12">
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex items-center">
              ...
              {i < 3 && (
                <div className={`w-24 h-1 ${step > i ? 'bg-primary' : 'bg-gray-200'}`} />
              )}
            </div>
          ))}
        </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-light outline-none"
              />
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                disabled={loading}
                className="flex-1 py-4 bg-primary text-white font-semibold rounded-lg hover:bg-primary-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
