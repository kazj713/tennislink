...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative pt-16 pb-32 bg-gradient-to-br from-[#C41E3A] to-[#A81A32] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <Link
                href="/coaches"
                className="px-8 py-4 bg-white text-[#C41E3A] font-semibold rounded-lg hover:bg-gray-100 transition-colors"
              >
                找教练
              </Link>
              <Link
                href="/ai-analysis"
                className="px-8 py-4 bg-[#006DB7] text-white font-semibold rounded-lg hover:bg-[#005A9E] transition-colors border-2 border-white"
              >
                AI 分析
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-[#C41E3A]/10 rounded-2xl flex items-center justify-center mb-6">
            ...
            {/* 功能卡片 2 */}
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-[#006DB7]/10 rounded-2xl flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-[#006DB7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            ...
            <Link href="/coaches" className="text-[#C41E3A] hover:text-[#A81A32] font-semibold">
              查看全部 →
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Link href="/coaches/1" className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-br from-[#C41E3A] to-[#A81A32] flex items-center justify-center">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-[#C41E3A]">¥300/课时</span>
            ...
            <Link href="/coaches/2" className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-br from-[#006DB7] to-[#005A9E] flex items-center justify-center">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-[#C41E3A]">¥250/课时</span>
            ...
            <Link href="/coaches/3" className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-[#C41E3A]">¥200/课时</span>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-[#C41E3A] to-[#A81A32] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/register"
            className="inline-block px-8 py-4 bg-white text-[#C41E3A] font-semibold rounded-lg hover:bg-gray-100 transition-colors"
          >
            免费注册
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              ...
              <Link href="/login" className="hover:text-[#C41E3A] transition-colors">
                登录
              </Link>
              <Link href="/register" className="hover:text-[#C41E3A] transition-colors">
                注册
              </Link>
            </div>
          </div>
