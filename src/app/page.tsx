...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative pt-16 pb-32 bg-gradient-to-br from-primary to-primary-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              ...
              <Link
                href="/ai-analysis"
                className="px-8 py-4 bg-primary-light text-white font-semibold rounded-lg hover:bg-primary-dark transition-colors border-2 border-white"
              >
                AI 分析
              </Link>
            </div>
